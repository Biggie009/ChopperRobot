...
__mod_name__ = "Inline"
__help__ = """
 <b> INLINE BOT SERVICE OF CHOPPER </b> 
 
<i> I'll be more efficient as group admin.Anyone can use these commands through inline.</i>

<b>Syntax</b>
   @ChopperRobot [command] [query]
...
__MODULE__ = "Inline"
__HELP__ = """
 ==>> **INLINE BOT SERVICE OF CHOPPER** <<==
` I'll be more efficient as group admin.Anyone can use these commands through inline.`
